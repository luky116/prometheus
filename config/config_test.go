...
var expectedErrors = []struct {
	...
	},
	{
		...
		errMsg:   `parsing YAML file testdata/scrape_config_files_scrape_protocols.bad.yml: scrape_protocols: unknown scrape protocol unknown, supported:  "PrometheusText", "PrometheusProto", "OpenMetricsText" for scrape config with job name "node"`,
	},
	{
		filename: "scrape_config_files_scrape_protocols2.bad.yml",
		errMsg:   `parsing YAML file testdata/scrape_config_files_scrape_protocols2.bad.yml: duplicated protocol in scrape_protocols, got [openmetricstext prometheusproto OpenMetricsText] for scrape config with job name "node"`,
	},
}
